...
class NeonPayGatewayTest extends TestCase
{
    private NeonPayGateway $gateway;

    protected function setUp(): void
    {
        $this->gateway = PaymentGateway::neonpay([
            'ebik_key' => 'test_ebik_key',
            'testMode' => true,
        ]);
    }
    ...
    {
        $this->assertInstanceOf(NeonPayGateway::class, $this->gateway);
    ...
    {
        $this->assertEquals('NeonPay', $this->gateway->getName());
    }
    ...
    {
        $gw = PaymentGateway::create('neonpay', ['ebik_key' => 'test', 'testMode' => true]);
        $this->assertInstanceOf(NeonPayGateway::class, $gw);
    }

    public function testMissingRequiredConfigThrows(): void
    {
        $this->expectException(\InvalidArgumentException::class);
        PaymentGateway::neonpay(['testMode' => true]);
    }
